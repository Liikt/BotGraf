...
async def check_shitpost(client, message):
    ...
    if 'woah' in message.content.lower():
        embeded = discord.Embed(description='WOAH', color=discord.Colour(0xEB8D43))
        embeded.set_image(url='http://i0.kym-cdn.com/photos/images/newsfeed/001/279/920/054.png')
        await client.send_message(message.channel, embed=embeded)
